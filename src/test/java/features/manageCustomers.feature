...
#    When I click delete button at user account as <useraccountname> post code as <code> account number as <accountnumber>
#    Then I verify that manager can delete user account as <accountname> and post code as <postcode> account number as <deletedaccountnumber> unsuccessfully
#
#    Examples:
#      | useraccountname  | code   | accountnumber | accountname      | postcode | deletedaccountnumber |
#      | Hermoine Granger | E859AB | 1012          | Hermoine Granger | E859AB   | 1012                 |
#      | Albus Dumbledore | E859AB | 1001          | Albus Dumbledore | E859AB   | 1001                 |