...
public class ManageCustomerAccountTest {
    ...
    @Then("^I verify that manager can delete user account as (.*) and post code as (.*) account number as (.*) unsuccessfully$")
    public void verifyDeleUnSuccessfully(String accountNameInput, String postCode, String accountNumberInput) throws InterruptedException {
        getManageCustomerAccountPage().checkAccountExisted(accountNameInput, postCode, accountNumberInput, true);
    }
